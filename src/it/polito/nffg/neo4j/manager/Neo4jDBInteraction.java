...
public interface Neo4jDBInteraction {
	...
	{
		Nffg, Node, AclFirewall, EndHost, Antispam, Cache, DPI, Mailclient, Mailserver, NAT, VPNAccess, VPNExit, Webclient, Webserver;
	}
	...
	public it.polito.nffg.neo4j.jaxb.Node updateNode(it.polito.nffg.neo4j.jaxb.Node node, long graphId, long nodeId) throws MyNotFoundException, MyInvalidObjectException;
	...
	public it.polito.nffg.neo4j.jaxb.Node updateNeighbour(Neighbour neighbour, long graphId, long nodeId, long neighbourId) throws MyNotFoundException, MyInvalidObjectException;
